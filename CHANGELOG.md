# v1.0.35 (Tue Oct 15 2024)

#### ⚠️ Pushed to `main`

- Fix changelog ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix vs code types version ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Allow console logging ([@haydenbleasel](https://github.com/haydenbleasel))
...
# v1.0.19 (Sat May 20 2023)

#### ⚠️ Pushed to `main`

- Add production logging ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Resolves #5 ([@haydenbleasel](https://github.com/haydenbleasel))
